...
//   res.header("Access-Control-Allow-Methods", "CONNECT, DEBUG, DELETE, DONE, GET, HEAD, HTTP, HTTP/0.9, HTTP/1.0, HTTP/1.1, HTTP/2, OPTIONS, ORIGIN, ORIGINS, PATCH, POST, PUT, QUIC, REST, SESSION, SHOULD, SPDY, TRACE, TRACK")
...
//   res.json({msg: 'GET: This is CORS-enabled for all origins!'})    
// });
